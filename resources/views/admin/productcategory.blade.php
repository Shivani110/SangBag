                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="title nk-block-title">Product Category</h4>
                            </div>
                        </div>
        ...
        $('#myform').submit(function(e){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response[1] == 'edit'){
                        var html = '<input type="text" data-id="'+response[0].id+'" id="cname" class="" value="'+response[0].category_name+'" disabled="" style="border: none; background: transparent;">';
