            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog_left" data-aos="fade-up" data-aos-duration="2000">
                        ...
                        <div class="blog_article">
                            <div class="img">
                                <img src="{{ asset('asset/img/blogs_6.png') }}">
                            </div>
                            <div class="blog_left_category">
                                <div class="blog_left_date">
                                    <strong>Category </strong>
                        ...
                        <div class="blog_article">
                            <div class="img">
                                <img src="{{ asset('asset/img/blogs_7.png') }}">
                            </div>
                            <div class="blog_left_category">
                                <div class="blog_left_date">
                                    <strong>Category </strong>
                        ...
                        <div class="blog_article">
                            <div class="img">
                                <img src="{{ asset('asset/img/blogs_8.png') }}">
                            </div>
                            <div class="blog_left_category">
                                <div class="blog_left_date">
                                    <strong>Category </strong>
                    ...
                    <div class="paginetion_wreap">
                        <ul class="list-unstyled m-0">
                            <li><a href="#"><img src="{{ asset('asset/img/left_2.svg') }}"></a></li>
                            <li class="active"><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
                            <li><a href="#">3</a></li>
                            <li class="active"><a href="#"><img src="{{ asset('asset/img/right_1.svg') }}"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4">
