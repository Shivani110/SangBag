...
<body>
    ...
    <section class="banner_inner" style="background-image: url({{ asset('asset/img/banner_inner_7.png') }});">
        <div class="container">
            <div class="row">
    ...
    <section class="pcy_wrapper p_120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="pcy_contact">
                        <div data-aos="fade-right" data-aos-duration="3000">
                            <h2>Privacy Policy</h2>
                        </div>
                        <ul class="list-unstyled m-0" data-aos="fade-left" data-aos-duration="3000"> 
                            <li>
                            ...
                            <li>
                                <h6>Cites Of The Word In Classical Literature, Discovered </h6>
                                <p>
                            ...
                            <li>
                                <h6>It was popularised in the 1960s with the release of Letraset</h6>
                                <p>
                            ...
                            <li>
                                <h6>Lorem Ipsum, you need to be sure there isn't anything</h6>
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop
                                </p>
                            </li>
